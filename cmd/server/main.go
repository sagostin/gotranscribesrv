...
func main() {
	...
	openaiRealtimeHandler := handlers.NewOpenAIRealtimeHandler(sc, redactor, logManager, db.DB)
	openaiRealtimeS2SHandler := handlers.NewOpenAIRealtimeS2SHandler(sc, redactor, logManager, db.DB, cfg)
